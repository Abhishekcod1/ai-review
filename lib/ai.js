      ...
      messages: [
        {
          ...
          content: [`
            #PROBLEM STATEMENT
            -Background:
All Safe” is a trusted 25-year-old soap brand. They are now launching a revolutionary 2-in-1
product:
A bottle made of soap that contains liquid shampoo inside. Once the shampoo is
used up, the bottle itself can be used as soap to wash hands. This reduces plastic
waste and promotes sustainable hygiene.

-Assignment Objective:
Create a 3–5 slide social media post (not ad creatives) that educates the audience about
this unique product. The goal is awareness, not selling.

-Requirements:
1. Design Format:
○ Platform: Instagram carousel (1080x1080px preferred)
○ Total Slides: 3 to 5
2. Tone & Style:
○ Informative, clean, minimal, eco-friendly vibes
○ Use brand colors (assume soft greens, whites, earthy tones)
○ No pricing, CTA, or ad-like elements
○ Product reference Link : https://soapbottle.com/
○ Social Media : https://www.instagram.com/soapbottle_official/?hl=en
            `,
